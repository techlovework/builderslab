    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "New Contact Message from TemplateHub",
  ...
  const faqItems = [
    {
      ...
      answer:
        "After purchase, you can download your templates from your dashboard. You'll also receive an email with download links.",
    },
    {
      question: "Can I use templates for commercial projects?",
      answer:
        "Yes! All our templates come with a commercial license, allowing you to use them for client work and commercial projects.",
    },
    {
      question: "Do you offer custom development services?",
      answer:
        "Absolutely! We offer custom website development tailored to your specific needs. Contact us for a personalized quote.",
    },
    {
      question: "What's included with lifetime updates?",
      answer:
        "Lifetime updates include bug fixes, security patches, new features, and compatibility updates for modern browsers.",
    },
  ];
      ...
      <section className="bg-white py-20 px-4 sm:px-6 lg:px-8 border-b border-slate-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Have questions about our templates or need custom development? We'd
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a
                    href="#"
                    className="flex items-center space-x-3 p-3 rounded-xl border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all duration-200"
                  >
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl shadow-xl p-8 text-white">
                <MessageSquare className="w-8 h-8 mb-4 text-slate-300" />
